      ...
      <ul className="list-unstyled topnav-menu float-end mb-0">
                ...
                <div className="notification-list">
                  <a href="#" className="dropdown-item notify-item">
                    <div className="d-flex align-items-start">
                      <img className="d-flex me-2 rounded-circle" src="/lte/assets/images/users/user-2.jpg"
                  ...
                  <a href="#" className="dropdown-item notify-item">
                    <div className="d-flex align-items-start">
                      <img className="d-flex me-2 rounded-circle" src="/lte/assets/images/users/user-5.jpg"
                        alt="Generic placeholder image" height="32" />
                      <div className="w-100">
            ...
            <div className="noti-scroll" data-simplebar>
              ...
              <a href="#" className="dropdown-item notify-item active">
                <div className="notify-icon">
                  <img src="/lte/assets/images/users/user-1.jpg" className="img-fluid rounded-circle" alt="" />
                </div>
              ...
              <a href="#" className="dropdown-item notify-item">
                <div className="notify-icon">
                  <img src="/lte/assets/images/users/user-4.jpg" className="img-fluid rounded-circle" alt="" />
                </div>
        ...
        <li className="dropdown notification-list topbar-dropdown">
          <a className="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
            href="#" role="button" aria-haspopup="false" aria-expanded="false">
            <img src="/lte/assets/images/users/user-1.jpg" alt="user-image" className="rounded-circle" />
            <span className="pro-user-name ms-1">
              Manuel <i className="mdi mdi-chevron-down"></i>
            </span>
          </a>
