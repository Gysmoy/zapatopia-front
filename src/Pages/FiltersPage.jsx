      ...
      <main id='filters-page'>
        ...
        <section className="products-container">
          <div className="product-card">
            ...
            <p>S/ 450.00</p>
            <NotificationButton productId={1} />
          </div>
          <div className="product-card">
            ...
            <p>S/ 320.00</p>
            <NotificationButton productId={2} />
          </div>
          <div className="product-card">
            ...
            <p>S/ 380.00</p>
            <NotificationButton productId={3} />
          </div>
          <div className="product-card">
            ...
            <p>S/ 410.00</p>
            <NotificationButton productId={4} />
          </div>
          <div className="product-card">
            ...
            <p>S/ 290.00</p>
            <NotificationButton productId={5} />
          </div>
          <div className="product-card">
            ...
            <p>S/ 470.00</p>
            <NotificationButton productId={6} />
          </div>
          <div className="product-card">
            ...
            <p>S/ 360.00</p>
            <NotificationButton productId={7} />
          </div>
          <div className="product-card">
            ...
            <p>S/ 420.00</p>
            <NotificationButton productId={8} />
          </div>
        </section>
      </main>
    </div>
